  ...
  Widget build(BuildContext context){
    ...
    return LayoutBuilder(builder: (ctx, constraints) {
      ...
      child: SingleChildScrollView(
        child: Padding(padding: EdgeInsets.fromLTRB(20, 20, 20, keyboardSpace + 20),
        child: Column(
          children: [
            if (width >= 600)
               Row(
                ...
                Expanded(
                 ...
                 decoration: const InputDecoration(
                prefixText:'₹',
                label: Text('Amount', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),
                ),
              ),
            ),
           ), 
            ...
            const SizedBox(width: 15),
             Expanded(
              child: Row(
                ...
                children: [Text (_selectedDate == null ?'Select Date' : formatter.format(_selectedDate!)),
                IconButton(
